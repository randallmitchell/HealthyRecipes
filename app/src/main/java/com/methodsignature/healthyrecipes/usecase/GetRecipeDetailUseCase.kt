...
class GetRecipeDetailUseCase @Inject constructor(
    ...
    private fun com.methodsignature.healthyrecipes.service._api.recipe.model.Recipe.toRecipe(): Recipe {
        val dao = this
        return Recipe(
            id = dao.id,
            name = dao.name,
    ...
    private fun List<com.methodsignature.healthyrecipes.service._api.recipe.model.Ingredient>.toIngredientList(): List<Ingredient> {
        return map { dao ->
            Ingredient(
                units = dao.units,
